...
(function() {
  var BANNER, CoffeeScript, EventEmitter, FakeBlock, SWITCHES, compileJoin, compileOptions, compilePath, compileScript, compileStdio, exec, exists, failedFiles, fileFinished, forkNode, fs, generatedFiles, helpers, hidden, joinTimeout, notSources, onCompilationFinished, optionParser, optparse, opts, outputPath, parseOptions, path, printLine, printTokens, printWarn, removeSource, runningFiles, setRunningFiles, setTranslatingFile, sourceCode, sources, spawn, timeLog, unwatchDir, usage, useWinPathSep, version, wait, watch, watchDir, watchers, writeJs, _ref;
  ...
  compileScript = function(file, input, base) {
    var compiled, err, message, o, options, source, t, task, useColors;
    if (base == null) {
      base = null;
    }
    o = opts;
