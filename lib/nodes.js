...
(function() {
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.compileRoot = function(o) {
      var code, exp, fragments, i, match, name, node, node_i, prelude, preludeExps, reference_regexp, refpath, rest, thisFile, _i, _j, _k, _len, _len1, _len2, _ref2, _ref3, _ref4;
      o.indent = '';
      o.level = LEVEL_TOP;
      this.spaced = true;
      ...
      _ref3 = this.expressions;
      for (node_i = _j = 0, _len1 = _ref3.length; _j < _len1; node_i = ++_j) {
        node = _ref3[node_i];
        node.match([
          new Assign(new M("import_name"), new Call(mkVanillaID("require"), [new Value(M("module_name"))])), (function(_this) {
      ...
      for (node_i = _k = 0, _len2 = _ref4.length; _k < _len2; node_i = ++_k) {
        node = _ref4[node_i];
        node.match([
          new Call(mkVanillaID("define"), [
            ...
            return function(_arg) {
              var bodyExprs, iport, mLabels, mNames, mname, param, _l, _len3, _ref5, _ref6;
              ...
              for (_l = 0, _len3 = _ref5.length; _l < _len3; _l++) {
                _ref6 = _ref5[_l], iport = _ref6[0], param = _ref6[1];
                if (!param) {
    ...
    Block.prototype.compileWithDeclarations = function(o) {
      var assigns, declars, exp, fragments, freeVarRegexp, i, name, post, rest, scope, spaced, _i, _j, _len, _len1, _ref2, _ref3, _ref4, _ref5;
      fragments = [];
      post = [];
      _ref2 = this.expressions;
  ...
  exports.Literal = Literal = (function(_super) {
    ...
    Literal.prototype.compileNode = function(o) {
      var answer, code, m, stringContent, _ref2;
      code = this.value.reserved ? "\"" + this.value + "\"" : this.value;
      if (underscore.isString(code) && (_ref2 = code.match(/^'(.*)'$/) || false, m = _ref2[0], stringContent = _ref2[1], _ref2)) {
  ...
  exports.Comment = Comment = (function(_super) {
    ...
    Comment.prototype.compileNode = function(o, level) {
      var code, isTSCode, _ref2;
      if (!(_ref2 = this.comment.match(/^tsonly-- (.*)$/) || false, isTSCode = _ref2[0], code = _ref2[1], _ref2)) {
  ...
  exports.Call = Call = (function(_super) {
    ...
    Call.prototype.compileNode = function(o) {
      var arg, argIndex, compiledArgs, compiledArray, _i, _len, _ref2, _ref3;
  ...
  exports.Range = Range = (function(_super) {
    ...
    Range.prototype.compileArray = function(o) {
      var range, to, u_range_call, _i, _ref2, _ref3, _results;
  ...
  exports.Class = Class = (function(_super) {
    ...
    Class.prototype.compileNode = function(o) {
      var assign, ctor, decl, declaration, fn, indent, isStatic, member, memberCode, memberDecls, members, name, node, prelude, static_flag, vname, _i, _len, _o, _ref2;
      ...
      for (_i = 0, _len = memberDecls.length; _i < _len; _i++) {
        ...
        if (_ref2 = member.isa(new Assign(mkVanillaID('constructor'), M("ctor", Code))), ctor = _ref2.ctor, _ref2) {
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    Assign.prototype.compileNode = function(o) {
      var answer, compiledName, found, isValue, name, shouldExport, val, varBase, _ref2;
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      var answer, argscode, bodycode, bound, exportFlag, exprs, functionToken, idt, jsParam, lamExpr, member, param, params, ref, uniqs, usesThis, val, wasEmpty, _i, _len, _ref2, _ref3, _ref4;
      ...
      if (this.body.match([Yield, function() {}])) {
        functionToken += '*';
      }
      ...
      answer = flatten((this.isMethod && !this.bound ? [this.name.compileNode(o), argscode, this.makeCode(" "), bodycode] : this.isMethod && this.bound ? [this.name.compileNode(o), this.makeCode(" = "), argscode, this.makeCode(" => "), bodycode] : bound && (this.name == null) ? (o.scope.hasNoLocals() && (_ref4 = this.body.isa(new Block([
        new Return()["with"]({
          expression: M("lamExpr")
        })
      ])), lamExpr = _ref4.lamExpr, _ref4) ? bodycode = lamExpr.match([
      ...
      ]) : void 0, [argscode, this.makeCode(' => '), bodycode]) : (this.name != null) && !this.bound ? (exportFlag = this.shouldExport || this.front ? "export " : "", [this.makeCode("" + this.tab + exportFlag + functionToken + " "), this.name.compileNode(o), argscode, this.makeCode(" "), bodycode]) : !this.bound ? [this.makeCode(functionToken), argscode, this.makeCode(" "), bodycode] : this.nogen("bound non-method function has a name (internal compiler error)")));
  ...
  exports.For = For = (function(_super) {
    ...
    For.prototype.compileNode = function(o) {
      var body, bodyFragments, compare, compareDown, declare, declareDown, defPart, defPartFragments, down, forPartFragments, guardPart, idt1, increment, index, ivar, kvar, kvarAssign, lastJumps, loopType, lvar, name, namePart, ref, resultPart, returnResult, rvar, scope, source, step, stepNum, stepVar, svar, topPart, varPart, _ref2, _ref3;
