...
(function() {
  ...
  exports.Class = Class = (function(_super) {
    ...
    Class.prototype.compileNode = function(o) {
      ...
      indent = "" + o.indent;
      prelude = [];
      declaration = [this.makeCode(indent), this.makeCode(this.shouldExport ? "export " : ""), this.makeCode("export class " + name), this.parent ? [this.makeCode(" extends "), this.parent.compileToFragments(o)] : [], this.makeCode(" {\n")];
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    Assign.prototype.compileNode = function(o) {
      var answer, compiledName, found, isValue, name, val, varBase, _ref6;
      ...
      if (!this.context) {
        ...
        if (!(typeof varBase.hasProperties === "function" ? varBase.hasProperties() : void 0)) {
          if (this.param) {
            ...
            if (!found) {
              compiledName.unshift(new CodeFragment(this.variable, 'var '));
            }
          }
        }
      }
