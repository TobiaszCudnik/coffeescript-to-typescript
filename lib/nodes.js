...
(function() {
  ...
  exports.Code = Code = (function(_super) {
    ...
    Code.prototype.compileNode = function(o) {
      var answer, argscode, bodycode, bound, exportFlag, exprs, functionToken, idt, jsParam, lamExpr, member, param, params, ref, uniqs, usesThis, val, wasEmpty, _i, _len, _ref6, _ref7, _ref8,
        _this = this;
  ...
  exports.For = For = (function(_super) {
    ...
    For.prototype.compileNode = function(o) {
      var body, bodyFragments, compare, compareDown, declare, declareDown, defPart, defPartFragments, down, forPartFragments, guardPart, idt1, increment, index, ivar, kvar, kvarAssign, lastJumps, loopType, lvar, name, namePart, ref, resultPart, returnResult, rvar, scope, source, step, stepNum, stepVar, svar, topPart, varPart, _ref6, _ref7;
